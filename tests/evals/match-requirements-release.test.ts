...
function completeSummary(): EvalSummary {
  return {
    ...
    dataset: {
      ...
      humanReviewedRate: 1,
      suiteCases: {
        "match.requirements.component": 50,
        "match.tier2.component": 50,
        "match.verification.component": 50,
        "match.repair.component": 16,
        "match.full-flow": 50,
      },
    },
    groups: [
      group("match.requirements.component", 50),
      group("match.tier2.component", 50),
      group("match.verification.component", 50),
      group("match.repair.component", 16),
      group("match.full-flow", 50),
    ],
  };
}
