...
- Use knowledgeContext to interpret broad requirement language and understand how related evidence fits together. It is a retrieval aid, not independently citable evidence.
...
- Every matched or partial row must cite one of the supplied canonicalCitations and copy its exact excerpt. Use no source outside the supplied notes.
